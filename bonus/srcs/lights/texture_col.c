...
/*   Updated: 2022/09/16 00:57:00 by fmauguin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	do_tex_bump3(t_xpm *bump, t_hit *hit)
{
	t_rgb		tex_rgb;
	t_couplef	uv;
	...
	if (bump)
	{
		...
		bump->coeff = (float)(tex_rgb.r + tex_rgb.g + tex_rgb.b)
			/ (255.0f * 3.0f);
	}
}
