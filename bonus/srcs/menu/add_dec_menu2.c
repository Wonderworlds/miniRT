...
static void	add_dec_plane2(t_plane *pl, int i, t_menu *menu)
{
	if (menu->field_index == 4)
		add_dec_double(&pl->vec3.x, i, gen_lim(-1, 1));
	else if (menu->field_index == 5)
		add_dec_double(&pl->vec3.y, i, gen_lim(-1, 1));
	else if (menu->field_index == 6)
		add_dec_double(&pl->vec3.z, i, gen_lim(-1, 1));
...
int	add_dec_plane(t_data *data, int i)
{
	...
	if (menu->field_index == 1)
		add_dec_double(&pl->pos.x, i, gen_lim(-10000, 10000));
	else if (menu->field_index == 2)
		add_dec_double(&pl->pos.y, i, gen_lim(-10000, 10000));
	else if (menu->field_index == 3)
		add_dec_double(&pl->pos.z, i, gen_lim(-10000, 10000));
	else
...
{
	if (menu->field_index == 4)
		add_dec_double(&cy->vec3.x, i, gen_lim(-1, 1));
	else if (menu->field_index == 5)
		add_dec_double(&cy->vec3.y, i, gen_lim(-1, 1));
	else if (menu->field_index == 6)
		add_dec_double(&cy->vec3.z, i, gen_lim(-1, 1));
	else if (menu->field_index == 7)
		add_dec_double(&cy->h, i, gen_lim(0, 10000));
	else if (menu->field_index == 8)
		add_dec_double(&cy->d, i, gen_lim(0, 10000));
	else if (menu->field_index == 9)
...
int	add_dec_cylinder(t_data *data, int i)
{
	...
	cy = (t_vol *)(ft_lst_at(data->scene->vols,
				menu->index)->content);
	if (menu->field_index == 1)
		add_dec_double(&cy->pos.x, i, gen_lim(-10000, 10000));
	else if (menu->field_index == 2)
		add_dec_double(&cy->pos.y, i, gen_lim(-10000, 10000));
	else if (menu->field_index == 3)
		add_dec_double(&cy->pos.z, i, gen_lim(-10000, 10000));
	else
