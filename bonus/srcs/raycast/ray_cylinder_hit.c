...
/*   Updated: 2022/09/15 18:19:22 by fmauguin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static double	set_t(t_pos *e, t_pos cy, t_ray *ray, t_pos cy_vec3)
{
...
static double	set_t2(double dot, double denom, t_bool *dir, t_bool sign)
{
	*dir = sign;
	return (dot / denom);
}
